...
//     socialMedia: {
//      facebook: "https://www.facebook.com/people/Bizhar-Heritag-E/61586597638647/",
//   instagram: "https://www.instagram.com/bizharheritage/",
//   twitter: "https://x.com/BiZharheritage",
//   linkedin: "https://www.linkedin.com/company/bizhar-heritage/posts/?feedView=all",
//   youtube: "https://youtube.com/@bizharheritage?si=xzHmpWtKVZ9hpyg5",
//     }
//   };
...
const ContactPage = () => {
  ...
  const companyInfo = {
    name: "Bizhar Heritage",
    tagline: "Connecting Handicraft Artists Across India",
    addresses: [
      {
        city: "Ranchi",
        address: "Brajpur Ratu, Ranchi, Jharkhand 835222",
  ...
  const handleSubmit = (e) => {
    ...
    const whatsappMessage =
      `✨ *BIZHAR HERITAGE ENQUIRY* ✨\n\n` +
      `🙏 *Greetings from Bizhar Heritage*\n\n` +
      `Connecting Handicraft Artists Across India — empowering artisans and celebrating true craftsmanship.\n\n` +
      `*Customer Details:*\n` +
      `👤 *Name:* ${formData.name}\n` +
      `🏢 *Company:* ${formData.company}\n` +
      `📧 *Email:* ${formData.email}\n` +
    ...
    const emailBody =
      `BIZHAR HERITAGE ENQUIRY\n\n` +
      `Connecting Handicraft Artists Across India — promoting authentic art and heritage.\n\n` +
      `Customer Name: ${formData.name}\n` +
      `Company: ${formData.company}\n` +
      `Email: ${formData.email}\n` +
      `Mobile: ${formData.mobile}\n\n` +
  ...
  const directWhatsApp = (whatsappNumber) => {
    const defaultMessage =
      `Hello Bizhar Heritage Team 🙏\n\n` +
      `I am interested in authentic handicrafts and connecting with skilled artists across India. ` +
      `Please share details and catalogue.\n\n` +
      `Thank you 🌿`;
    ...
    <>
      <div className="bh-contact-root">
        <div className="bh-contact-page">
          ...
          <div className="bh-hero-banner">
            <div className="bh-hero-content">
              <h1 className="bh-hero-title">Bizhar Heritage</h1>
              <div className="bh-hero-tagline">Connecting Handicraft Artists Across India</div>
              <div className="bh-hero-subtitle">
                Empowering artisans, preserving traditions, and celebrating authentic craftsmanship
              </div>
            </div>
          </div>
          ...
          <div className="bh-contact-container">
            <div className="bh-contact-layout">
              ...
              <div className="bh-form-section">
                ...
                <form onSubmit={handleSubmit}>
                  <div className="bh-form-row">
                    <div className="bh-form-group">
                      <label className="bh-form-label" htmlFor="bh-name">
                        Full Name *
                      </label>
                      <input
                        type="text"
                    ...
                    <div className="bh-form-group">
                      <label className="bh-form-label" htmlFor="bh-company">
                        Company Name
                      </label>
                      <input
                        type="text"
                  ...
                  <div className="bh-form-row">
                    <div className="bh-form-group">
                      <label className="bh-form-label" htmlFor="bh-email">
                        Email Address *
                      </label>
                      <input
                        type="email"
                    ...
                    <div className="bh-form-group">
                      <label className="bh-form-label" htmlFor="bh-mobile">
                        Mobile Number *
                      </label>
                      <input
                        type="tel"
                  ...
                  <div className="bh-form-group">
                    <label className="bh-form-label" htmlFor="bh-message">
                      Your Requirements
                    </label>
                    <textarea
                      id="bh-message"
              ...
              <div className="bh-address-section">
                  ...
                  <div key={index} className="bh-address-card">
                    ...
                    <div className="bh-address-details">
                      ...
                      <div className="bh-action-buttons">
                        ...
                        <button
                          className="bh-action-btn bh-map-btn"
                          onClick={() => openGoogleMaps(office.address)}
                          aria-label="View on Map"
                        >
                          <FaMap /> Map
                ...
                {/* Social Media & Map Links */}
                <div className="bh-links-section">
                  <h3 style={{ color: "#1f2937", marginBottom: "15px", fontSize: "1.3rem" }}>
                    Connect With Us
                  </h3>
                  <div className="bh-links-grid">
                    <a
            ...
            {/* Map Section */}
            <div className="bh-map-section">
              <h2 className="bh-map-title">📍 Our Location</h2>
              <p className="bh-map-subtitle">Visit us at our Ranchi office – we're happy to guide you!</p>

              <div className="bh-map-container">
                <div className="bh-map-info">
                  <h3>Bizhar Heritage</h3>
                  <p>
                    Brajpur Ratu <br />
                    Ranchi, Jharkhand – <strong>835222</strong>
                    <br />
                    India
                  </p>
