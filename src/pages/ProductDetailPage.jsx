...
Please confirm the order.`;
    ...
    return (
        <>
            ...
            <Helmet>
                <title>
                    {product?.brand} | Buy Online at BiZhar Heritage
                </title>
                ...
                <meta
                    ...
                    content={
                        ...
                        `Buy ${product?.brand} online from BiZhar Heritage`
                    }
                />
    ...
    `}
                ...
                <link
                    rel="canonical"
                    href={`https://www.bizharheritage.com/product/${product?.id}`}
                />

                {/* Open Graph */}
                <meta property="og:type" content="product" />
                <meta property="og:title" content={product?.brand} />
                <meta
                ...
                <meta
                    property="og:url"
                    content={`https://www.bizharheritage.com/product/${product?.id}`}
                />

                {/* Twitter */}
                <meta name="twitter:card" content="summary_large_image" />
                <meta name="twitter:title" content={product?.brand} />
                <meta
                ...
                <script type="application/ld+json">
                    {JSON.stringify({
                        ...
                        offers: {
                            "@type": "Offer",
                            url: `https://www.bizharheritage.com/product/${product?.id}`,
                            priceCurrency: "INR",
                        ...
                        itemListElement: [
                            {
                                ...
                                position: 1,
                                name: "Home",
                                item: "https://www.bizharheritage.com"
                            },
                            {
                                "@type": "ListItem",
                                position: 2,
                                name: product?.category,
                                item: `https://www.bizharheritage.com/category/${product?.category}`
                            },
                            {
                                "@type": "ListItem",
                                position: 3,
                                name: product?.brand,
                                item: `https://www.bizharheritage.com/product/${product?.id}`
                            }
                        ]
                    })}
                </script>
                                ...
                                <div className="pdp-gallery-sticky">
                                    <div className="pdp-main-image-wrapper" style={{ position: 'relative' }}>
                                        <img
                                            ...
                                            alt={`${product.brand} Handmade Handicraft Product`}
                                            title={product.brand}
                                            loading="eager"
                                            className="pdp-main-image"
                                            onError={(e) => {
                                                e.target.src =
                                                    "https://via.placeholder.com/600x700?text=Image+Not+Available";
                                            }}
                                        />
