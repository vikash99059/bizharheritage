...
const categories = {
  ...
  "Tikuli Art": ["Coaster Set", "Jewellery Box", "Decorative Tray"],
  "Manjusha Art": ["Silk Dupatta", "Wall Hanging"]
};
...
const items = [
  {
    ...
    image: "https://images.unsplash.com/photo-1582582621959-48d27397dc69",
    video: "https://www.w3schools.com/html/mov_bbb.mp4",
    story: "Madhubani painting is a traditional art from Bihar."
  },
  {
    id: 2,
    category: "Tikuli Art",
    ...
    image: "https://images.unsplash.com/photo-1616628182501-87c21e5c8d3b",
    video: "https://www.w3schools.com/html/mov_bbb.mp4",
    story: "Tikuli art is an ancient glass painting technique."
  }
];
      ...
      <main className="bm-content">
        {filtered.map((item) => (
          <div key={item.id} className="heritage-card">
            {/* IMAGE */}
            <div className="heritage-img">
              <img src={item.image} alt={safe(item.name)} />
              <span className="fav" onClick={() => toggleFav(item.id)}>
                {fav.includes(item.id) ? <FaHeart /> : <FaRegHeart />}
              </span>
            </div>
            ...
            <div className="heritage-info">
              ...
              <div className="price">
                <span className="old">₹{safe(item.price)}</span>
                <span className="new">₹{safe(item.offerPrice)}</span>
              </div>
              ...
              {expanded === item.id && (
                <div className="story-box">
                  ...
                  <div className="story-text">
                    ...
                    <ul>
                      <li>Material: Natural pigments</li>
                      <li>Origin: Bihar</li>
                      <li>Artist: Local artisans</li>
                    </ul>
                  </div>
                </div>
              )}
